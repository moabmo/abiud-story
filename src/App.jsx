    ...
    <main className="min-h-screen bg-[#f7f9fc] text-slate-900">
      ...
      <section className="mx-auto grid max-w-7xl gap-5 px-6 pb-24 md:grid-cols-2 lg:grid-cols-3 md:px-10">
        {chapters.map((chapter) => {
          ...
          return (
            <div key={chapter.title} className="group relative overflow-hidden rounded-[2rem] border border-white/40 bg-white/70 p-7 shadow-[0_10px_40px_rgba(2,6,23,0.08)] backdrop-blur-xl transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_60px_rgba(2,6,23,0.15)]">
